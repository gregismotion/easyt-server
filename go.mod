...
require (
	...
	git.freeself.one/thegergo02/easyt/storage v0.0.0-00010101000000-000000000000 // indirect
	git.freeself.one/thegergo02/easyt/storage/backends/memory v0.0.0-00010101000000-000000000000 // indirect
